import {
  require_react_dom
} from "./chunk-MR2V3EHZ.js";
import {
  __commonJS,
  __toESM,
  require_react
} from "./chunk-KPNZMFXF.js";
...
function PrefetchPageLinksImpl({
  ...
  return React8.createElement(React8.Fragment, null, dataHrefs.map((href2) => React8.createElement("link", { key: href2, rel: "prefetch", as: "fetch", href: href2, ...linkProps })), moduleHrefs.map((href2) => React8.createElement("link", { key: href2, rel: "modulepreload", href: href2, ...linkProps })), keyedPrefetchLinks.map(({ key, link }) => React8.createElement("link", { key, ...link })));
}
function Meta() {
...
try {
  if (isBrowser) {
    window.__reactRouterVersion = "7.7.0";
  }
} catch (e) {
}
...
function createCallServer({
  ...
  return async (id, args) => {
    var _a;
    let actionId = globalVar.__routerActionID = ((_a = globalVar.__routerActionID) != null ? _a : globalVar.__routerActionID = 0) + 1;
          ...
          if (landedActionId < actionId && globalVar.__routerActionID <= actionId) {
            ...
            for (const match of rerender.matches) {
              globalVar.__router.patchRoutes(
                (_a2 = lastMatch == null ? void 0 : lastMatch.id) != null ? _a2 : null,
...
function createRouterFromPayload({
  ...
  globalVar.__router.subscribe(({ loaderData, actionData }) => {
    ...
    if (lastLoaderData !== loaderData) {
      globalVar.__routerActionID = ((_a2 = globalVar.__routerActionID) != null ? _a2 : globalVar.__routerActionID = 0) + 1;
    }
  });
  return globalVar.__router;
}
      ...
      if (renderedRoutes) {
        for (const rendered of renderedRoutes) {
          window.__router.patchRoutes(
            (_a = rendered.parentId) != null ? _a : null,
...
function RSCHydratedRouter({
  ...
  React42.useEffect(() => {
    var _a, _b;
    if (routeDiscovery === "lazy" || ((_b = (_a = window.navigator) == null ? void 0 : _a.connection) == null ? void 0 : _b.saveData) === true) {
      return;
    }
    function registerElement(el) {
      let path = el.tagName === "FORM" ? el.getAttribute("action") : el.getAttribute("href");
...
function createRouteFromServerManifest(match, payload) {
  ...
  let isHydrationRequest = ((_b = match.clientLoader) == null ? void 0 : _b.hydrate) === true || !match.hasLoader || match.hasComponent && !match.element;
  let dataRoute = {
    id: match.id,
...
function getManifestUrl(paths) {
  ...
  const globalVar = window;
  let basename = ((_a = globalVar.__router.basename) != null ? _a : "").replace(/^\/|\/$/g, "");
